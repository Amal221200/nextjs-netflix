        ...
        <div className="mt-24 py-10 px-6 bg-black/80 rounded md:mt-0 md:max-w-sm md:px-14">
            <form method="post" action="/api/auth/signin">
                ...
                <div className="space-y-4 mt-5">
                    ...
                    <Button type="submit" variant="destructive" className="w-full bg-[#e50914] text-white">Log In</Button>
                </div>
            </form>

            <div className="mt-2 text-center">
                <p className="text-gray-500 text-sm">New to Netflix? <Link href="/sign-up" prefetch className="text-white hover:underline">Sign Up</Link></p>
            </div>
